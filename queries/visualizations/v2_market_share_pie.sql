-- ============================================================================
-- DASHBOARD WIDGET: Stablecoin Market Share (Pie Chart)
-- ============================================================================
-- Dune Widget-Typ: Pie Chart
-- X-Achse: symbol | Y-Achse: volume_share_pct
-- Zeigt Marktanteile nach Volumen und optional nach Transaktionen.
--
-- Parameter: {{period}}
-- ============================================================================
...
-- PIE CHART: symbol -> volume_share_pct
SELECT
    v.symbol,
    v.total_volume,
    v.total_txs,
