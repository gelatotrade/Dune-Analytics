-- ============================================================================
-- DASHBOARD WIDGET: Chain x Stablecoin Heatmap
-- ============================================================================
-- Dune Widget-Typ: Table (mit Heatmap-Farbkodierung) oder Pivot Table
-- Zeigt eine Matrix: Chains (Zeilen) x Stablecoins (Spalten) mit Volumen.
-- Erlaubt sofort zu sehen welcher Stablecoin auf welcher Chain dominiert.
--
-- Parameter: {{period}}
-- ============================================================================
...
chain_totals AS (
    SELECT
        blockchain,
        SUM(volume) AS chain_total_volume
    FROM chain_coin_volume
    GROUP BY blockchain
)

-- HEATMAP / PIVOT TABLE
-- Dune: Tabelle mit bedingter Formatierung
-- Zeilen = blockchain, Spalten = symbol, Werte = volume
SELECT
    v.blockchain,
    v.symbol,
    v.volume,
