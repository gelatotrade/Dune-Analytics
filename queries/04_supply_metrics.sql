-- ============================================================================
-- Dune Analytics: Stablecoin Supply Metrics (21 Chains)
-- ============================================================================
-- Trackt Mint/Burn-Events und Supply-Entwicklung aller Stablecoins.
--
-- Parameter: {{period}}
-- ============================================================================
...
SELECT
    day, blockchain, symbol,
    daily_minted, daily_burned, daily_net_supply_change,
