-- ============================================================================
-- Dune Analytics: Multi-Chain Stablecoin Transfer Tracking (21 Chains)
-- ============================================================================
-- Trackt alle ERC20-Transfers der definierten Stablecoins ueber alle
-- unterstuetzten EVM-Chains. Fuer non-EVM siehe 08/09.
--
-- Parameter (Dune UI):
...
WITH stablecoins AS (
    SELECT * FROM (VALUES
        ...
        ('DAI',  'zkevm',       0xc5015b9d9161dca7e18e32f6f25c4ad850731fd4, 18),
        -- USDS
        ...
        ('FRAX', 'polygon',     0x45c32fa6df82ead1e2ef74d17b76547eddfaff89, 18),
        -- GHO, crvUSD, PYUSD
        ...
        ('USDP', 'ethereum',    0x8e870d67f660d95d5be530380d0ec0bd388289e1, 18),
        -- USDB (Blast native)
